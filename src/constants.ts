...
export const FRAMES: FrameStyle[] = [
  ...
  },
  {
    id: 'silky_korean',
    name: 'Silky Korean 🌸',
    bgColor: 'bg-[#fff0f6] border-[#ff87b2]',
    textColor: 'text-[#e64980]',
    borderColor: 'border-[#ff87b2]',
    canvasBg: '#fff0f6',
    canvasText: '#e64980',
    canvasBorder: '#ff87b2',
    styleName: 'Silky Korean Premium',
    description: 'Desain bingkai Silky Korean manis dengan warna pink lembut'
  },
  {
    id: 'silky_matcha',
    name: 'Silky Matcha 🍵',
    bgColor: 'bg-[#f4fbf7] border-[#2b8a3e]',
    textColor: 'text-[#2b8a3e]',
    borderColor: 'border-[#2b8a3e]',
    canvasBg: '#f4fbf7',
    canvasText: '#2b8a3e',
    canvasBorder: '#2b8a3e',
    styleName: 'Silky Matcha Premium',
    description: 'Desain bingkai Silky Matcha elegan bernuansa hijau gelap teh matcha'
  },
  {
    id: 'silky_bubble',
    name: 'Silky Bubble 🫧',
    bgColor: 'bg-[#f0f9ff] border-[#0c85e9]',
    textColor: 'text-[#0c85e9]',
    borderColor: 'border-[#0c85e9]',
    canvasBg: '#f0f9ff',
    canvasText: '#0c85e9',
    canvasBorder: '#0c85e9',
    styleName: 'Silky Bubble Premium',
    description: 'Desain bingkai Silky Bubble ceria bernuansa biru langit yang segar'
  },
  {
    id: 'etawa',
    name: 'Etawa 🥛',
