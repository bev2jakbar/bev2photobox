...
// @ts-ignore
import overlayNutrijellGridImg from '../assets/images/ovnj_grid.png';
// @ts-ignore
import angetSariFrameBg from '../assets/images/bc_anget.png';
// @ts-ignore
import overlayAngetSariImg from '../assets/images/ov_anget.png';
// @ts-ignore
import silkyFrameBg from '../assets/images/bc_silky.png';
// @ts-ignore
import overlayKoreanImg from '../assets/images/ov_korean.png';
// @ts-ignore
import overlayMatchaImg from '../assets/images/ov_matcha.png';
// @ts-ignore
import overlayBubbleImg from '../assets/images/ov_bubble.png';
...
export default function PhotoboxPreview({
  ...
  const isCustomTemplateFrame = activeFrame.id === 'tts1' || activeFrame.id === 'tts2' || activeFrame.id === 'tts3' || activeFrame.id === 'gummyberry' || activeFrame.id === 'strawberry' || activeFrame.id === 'popice_candy' || activeFrame.id === 'etawa' || activeFrame.id === 'nutrijell' || activeFrame.id === 'anget_sari' || activeFrame.id === 'silky_korean' || activeFrame.id === 'silky_matcha' || activeFrame.id === 'silky_bubble';
  ...
  const getCustomFrameBg = () => {
    ...
    if (activeFrame.id === 'silky_korean' || activeFrame.id === 'silky_matcha' || activeFrame.id === 'silky_bubble') return silkyFrameBg;
    return null;
  };
  ...
  const renderCardToCanvas = async (setLoadingStatus: (msg: string) => void) => {
    ...
    if (isCustomTemplateFrame) {
      try {
        ...
        } else if (activeFrame.id === 'silky_korean') {
          frameImgBg = silkyFrameBg;
          frameLabel = 'Silky Korean';
        } else if (activeFrame.id === 'silky_matcha') {
          frameImgBg = silkyFrameBg;
          frameLabel = 'Silky Matcha';
        } else if (activeFrame.id === 'silky_bubble') {
          frameImgBg = silkyFrameBg;
          frameLabel = 'Silky Bubble';
        }
    ...
    if (isCustomTemplateFrame) {
      ...
      if (activeFrame.id === 'nutrijell') {
        try {
          const stickerImg = await loadImage(isSinglePhoto ? overlayNutrijellImg : overlayNutrijellGridImg);
      ...
      if (activeFrame.id === 'silky_korean') {
        try {
          const stickerImg = await loadImage(overlayKoreanImg);
          const stickerWidth = cardWidth; // 100% of total card width
          const stickerHeight = stickerWidth * (stickerImg.height / stickerImg.width);
          const stickerX = 0; // Left-aligned
          const stickerY = cardHeight - stickerHeight; // Bottom aligned
          ctx.save();
          ctx.drawImage(stickerImg, stickerX, stickerY, stickerWidth, stickerHeight);
          ctx.restore();
        } catch (err) {
          console.error('Gagal memuat stiker Silky Korean:', err);
        }
      }

      if (activeFrame.id === 'silky_matcha') {
        try {
          const stickerImg = await loadImage(overlayMatchaImg);
          const stickerWidth = cardWidth; // 100% of total card width
          const stickerHeight = stickerWidth * (stickerImg.height / stickerImg.width);
          const stickerX = 0; // Left-aligned
          const stickerY = cardHeight - stickerHeight; // Bottom aligned
          ...
          console.error('Gagal memuat stiker Silky Matcha:', err);
        }
      }

      if (activeFrame.id === 'silky_bubble') {
        try {
          const stickerImg = await loadImage(overlayBubbleImg);
          const stickerWidth = cardWidth; // 100% of total card width
          const stickerHeight = stickerWidth * (stickerImg.height / stickerImg.width);
          const stickerX = 0; // Left-aligned
          const stickerY = cardHeight - stickerHeight; // Bottom aligned
          ...
          console.error('Gagal memuat stiker Silky Bubble:', err);
        }
      }
    }
        ...
        <div className="w-full flex justify-center">
          ...
          >
            ...
            {activeFrame.id === 'nutrijell' && (
              <img
                src={currentPhotos.length === 1 ? overlayNutrijellImg : overlayNutrijellGridImg}
            ...
            {activeFrame.id === 'silky_korean' && (
              <img
                src={overlayKoreanImg}
                alt="Sticker Silky Korean"
                className="absolute z-40 pointer-events-none select-none"
                style={{
                  left: '0%',
                  width: '100%',
            ...
            {activeFrame.id === 'silky_matcha' && (
              <img
                src={overlayMatchaImg}
                alt="Sticker Silky Matcha"
                className="absolute z-40 pointer-events-none select-none"
                style={{
                  left: '0%',
                  width: '100%',
            ...
            {activeFrame.id === 'silky_bubble' && (
              <img
                src={overlayBubbleImg}
                alt="Sticker Silky Bubble"
                className="absolute z-40 pointer-events-none select-none"
                style={{
                  left: '0%',
                  width: '100%',
